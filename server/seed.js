...
const volunteers = [
  { name: 'Priya M.', initials: 'P', color: '#6366f1', status: 'available', specialties: ['Anxiety', 'Academic Stress', 'Loneliness'], sessions: 142, rating: 4.9, responseTime: '< 1 min', bio: "I'm here to listen, not judge." },
  { name: 'Arjun K.', initials: 'A', color: '#8b5cf6', status: 'available', specialties: ['Depression', 'Family Issues', 'Career'], sessions: 89, rating: 4.8, responseTime: '2 min', bio: 'Trained in emotional first aid.' },
  { name: 'Sneha R.', initials: 'S', color: '#14b8a6', status: 'available', specialties: ['Relationships', 'Self-esteem', 'Grief'], sessions: 201, rating: 5.0, responseTime: '< 1 min', bio: 'Your feelings are valid.' },
  { name: 'Rahul D.', initials: 'R', color: '#f59e0b', status: 'away', specialties: ['Panic Attacks', 'Trauma', 'Identity'], sessions: 67, rating: 4.7, responseTime: '~5 min', bio: "Here when you're ready to talk." },
  { name: 'Meera T.', initials: 'M', color: '#f43f5e', status: 'available', specialties: ['Body Image', 'Social Anxiety', 'Burnout'], sessions: 178, rating: 4.9, responseTime: '< 1 min', bio: 'Small steps are still steps forward.' },
  { name: 'Vikram P.', initials: 'V', color: '#22c55e', status: 'available', specialties: ['Study Stress', 'Peer Pressure', 'Motivation'], sessions: 54, rating: 4.6, responseTime: '3 min', bio: 'You reached out — that took courage.' },
];
...
mongoose.connect(process.env.MONGO_URI).then(async () => {
  ...
  console.log('Seeded volunteers, clinics, and vents');
  process.exit(0);
